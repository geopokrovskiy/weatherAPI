...
import com.geopokrovskiy.security.AuthenticationManager;
import com.geopokrovskiy.security.BearerTokenServerAuthenticationConverter;
...
public class WebSecurityConfig {
    ...
    private final String[] publicRoutes = {"/api/v1/auth/register/*", "/api/v1/stations/*"};
