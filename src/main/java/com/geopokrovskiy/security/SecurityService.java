        ...
        return userService.getUserByUsername(username)
                .flatMap(user -> {
                    ...
                    if (!passwordEncoder.matches(password, user.getPassword())) {
                        return Mono.error(new AuthException("Invalid password!", ErrorCodes.INVALID_PASSWORD));
                    }
                ...
                .switchIfEmpty(Mono.error(new AuthException("Invalid credentials!", ErrorCodes.INVALID_USERNAME)));
    }
}
